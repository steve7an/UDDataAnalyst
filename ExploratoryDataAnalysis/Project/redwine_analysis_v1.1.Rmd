...
```{r shared functions}
plotAcid <- function(df, colsize=1, selcolor='blue', selbin=30){
    p1 = qplot(data = df, x = fixed.acidity, bins=selbin, fill = I(selcolor), col =I('black'))
    p2 = qplot(data = df, x = volatile.acidity, bins=selbin, fill = I(selcolor), col =I('black'))
    p3 = qplot(data = df, x = citric.acid, bins=selbin, fill = I(selcolor), col =I('black'))
    p4 = qplot(data = df, x = chlorides, bins=selbin, fill = I(selcolor), col =I('black'))
    p5 = qplot(data = df, x = pH, bins=selbin, fill = I(selcolor), col =I('black'))
    grid.arrange(p1, p2, p3, p4, p5, ncol=colsize)
}

plotDensity <- function(df, colsize=1, selcolor='green', selbin=30){
    p1 = qplot(data = df, x = residual.sugar, bins=selbin, fill = I(selcolor), col =I('black'))
    p2 = qplot(data = df, x = alcohol, bins=selbin, fill = I(selcolor), col =I('black'))
    p3 = qplot(data = df, x = density, bins=selbin, fill = I(selcolor), col =I('black'))
    grid.arrange(p1, p2, p3, ncol=colsize)
}

plotSulfur <- function(df, colsize=1, selcolor='red', selbin=30){
    p1 = qplot(data = df, x = sulphates, bins=selbin, fill = I(selcolor), col =I('black'))
    p2 = qplot(data = df, x = free.sulfur.dioxide, bins=selbin, fill = I(selcolor), col =I('black'))
    p3 = qplot(data = df, x = bound.sulfur.dioxide, bins=selbin, fill = I(selcolor), col =I('black'))
    p4 = qplot(data = df, x = total.sulfur.dioxide, bins=selbin, fill = I(selcolor), col =I('black'))
    grid.arrange(p1, p2, p3, p4, ncol = colsize)
}

boxplotQuality <- function(element){
    ggplot(data = rwdf, aes(x=factor(quality), y=element, color=factor(quality))) +
    geom_jitter(alpha=1/3) +
    geom_boxplot(colour = "black", alpha=1/2) +
    scale_y_continuous(name = name(element))
}

sumAcid <- function(df){
    summary(df[c('fixed.acidity','volatile.acidity','citric.acid','chlorides','pH')])
}
...
sumSulfur <- function(df){
    summary(df[c('sulphates','free.sulfur.dioxide','bound.sulfur.dioxide','total.sulfur.dioxide')])
}

resPlot <- function(fit){
...
```{r Univariate_Plots2, fig.asp=0.4}
...
```{r Univariate_Plots4,fig.asp=0.9}
plotAcid(rwdf)
```
...
```{r Univariate_Plots6,fig.asp=0.9}
plotDensity(rwdf)
```
...
```{r Univariate_Plots9, fig.asp=0.9}
plotSulfur(rwdf)
```
...
rwdf$group <- ifelse(rwdf$quality >= 7, 'best', ifelse(rwdf$quality<=4,'worst','average'))
...
```{r Univariate_Plots12, fig.height=3, fig.width=12}
plotAcid(rwdf[rwdf$group=='best',],5)
```
...
```{r Univariate_Plots14, fig.height=3, fig.width=12}
plotAcid(rwdf[rwdf$group=='average',],5)
```
...
```{r Univariate_Plots16, fig.height=3, fig.width=12}
plotAcid(rwdf[rwdf$group=='worst',], 5)
```
...
```{r Univariate_Plots18, fig.height=3, fig.width=9}
plotDensity(rwdf[rwdf$group=='best',],3)
```
...
```{r Univariate_Plots20, fig.height=3, fig.width=9}
plotDensity(rwdf[rwdf$group=='average',],3)
```
...
```{r Univariate_Plots21}
print ('Worst Group')
sumDensity(rwdf[rwdf$group=='worst',])
```

```{r Univariate_Plots22, fig.height=3, fig.width=9}
plotDensity(rwdf[rwdf$group=='worst',],3)
```
...
```{r Univariate_Plots23}
print ('Best Group')
sumSulfur(rwdf[rwdf$group=='best',])
```

```{r Univariate_Plots24, fig.height=3, fig.width=12}
plotSulfur(rwdf[rwdf$group=='best',],4)
```
...
```{r Univariate_Plots25}
print ('Average Group')
sumSulfur(rwdf[rwdf$group=='average',])
```


```{r Univariate_Plots26, fig.height=3, fig.width=12}
plotSulfur(rwdf[rwdf$group=='average',],4)
```
...
```{r Univariate_Plots27}
print ('Worst Group')
sumSulfur(rwdf[rwdf$group=='worst',])
```

```{r Univariate_Plots28, fig.height=3, fig.width=12}
plotSulfur(rwdf[rwdf$group=='worst',],4)
```
...
chart.Correlation(rwdf[, -which(names(rwdf) %in% c('group', 'X') )], histogram=TRUE, pch=19)
```
...
res <- cor(rwdf[, -which(names(rwdf) %in% c('group') )])
...
ggplot(data = rwdf, aes(x=factor(quality), y=volatile.acidity, color=factor(quality))) +
    geom_jitter(alpha=1/3) +
    geom_boxplot(colour = "black", alpha=1/2)
```
...
ggplot(data = rwdf, aes(x=factor(quality), y=citric.acid, color=factor(quality))) +
    geom_jitter(alpha=1/3) +
    geom_boxplot(colour = "black", alpha=1/2)
```
...
ggplot(data = rwdf, aes(x=factor(quality), y=bound.sulfur.dioxide, color=factor(quality))) +
    geom_jitter(alpha=1/3) +
    geom_boxplot(colour = "black", alpha=1/2)
```
...
ggplot(data = rwdf, aes(x=factor(quality), y=total.sulfur.dioxide, color=factor(quality))) +
    geom_jitter(alpha=1/3) +
    geom_boxplot(colour = "black", alpha=1/2)
```
...
ggplot(data = rwdf, aes(x=factor(quality), y=fixed.acidity, color=factor(quality))) +
    geom_jitter(alpha=1/3) +
    geom_boxplot(colour = "black", alpha=1/2)
```
...
ggplot(data = rwdf[rwdf$volatile.acidity < quantile(rwdf$volatile.acidity,0.95),], aes(x=alcohol, y=volatile.acidity, color=factor(quality))) +
...
ggplot(data = rwdf[rwdf$citric.acid < quantile(rwdf$citric.acid, 0.95), ], aes(x=alcohol, y=citric.acid, color=factor(quality))) +
    geom_jitter(alpha=1/3, shape=21) +
    facet_wrap(~factor(quality), ncol=6)
```
...
ggplot(data = rwdf[rwdf$chlorides < quantile(rwdf$chlorides, 0.95),], aes(x=alcohol, y=chlorides, color=factor(quality))) +
    geom_jitter(alpha=1/3, shape=21) +
    facet_wrap(~factor(quality), ncol=6)
```
...
ggplot(data = rwdf[rwdf$density < quantile(rwdf$density, 0.95),], aes(x=alcohol, y=density, color=factor(quality))) +
    geom_jitter(alpha=1/3, shape=21) +
    facet_wrap(~factor(quality), ncol=6)
```
...
ggplot(data = rwdf, aes(x=sulphates, y=total.sulfur.dioxide, color=factor(quality))) +
    geom_jitter(alpha=1/3, shape=22) +
    facet_wrap(~factor(quality), ncol=6)
```
...
ggplot(data = rwdf[rwdf$total.sulfur.dioxide < quantile(rwdf$total.sulfur.dioxide, 0.95),], aes(x=sulphates, y=total.sulfur.dioxide, color=factor(quality))) +
    geom_jitter(alpha=1/3, shape=22) +
    facet_wrap(~factor(quality), ncol=6)
```
...
ggplot(data = rwdf, aes(x=sulphates, y=bound.sulfur.dioxide, color=factor(quality))) +
    geom_jitter(alpha=1/3, shape=22) +
    facet_wrap(~factor(quality), ncol=6)
```
...
ggplot(data = rwdf[rwdf$bound.sulfur.dioxide < quantile(rwdf$bound.sulfur.dioxide,0.95),], aes(x=sulphates, y=bound.sulfur.dioxide, color=factor(quality))) +
    geom_jitter(alpha=1/3, shape=22) +
    facet_wrap(~factor(quality), ncol=6)
```
...
p1 <- ggplot(data = rwdf, aes(x=factor(quality), y=alcohol, color=factor(quality))) +
    geom_jitter(alpha=1/3) +
    geom_boxplot(colour = "black", alpha=1/2) +
    labs(title='Quality by Alcohol Percentage', y = 'Alcohol percentage', x = 'Red Wine Quality') +
    theme(plot.title = element_text(hjust = 0.5))
p2 <- ggplot(data = rwdf, aes(x=factor(quality), y=volatile.acidity, color=factor(quality))) +
    geom_jitter(alpha=1/3) +
    geom_boxplot(colour = "black", alpha=1/2) +
    labs(title='Quality by Volatile Acidity', y = 'Acetic Acid g/dm^3', x = 'Red Wine Quality') +
    theme(plot.title = element_text(hjust = 0.5))
...
ggplot(data = rwdf[rwdf$volatile.acidity < quantile(rwdf$volatile.acidity,0.95),], aes(x=alcohol, y=volatile.acidity, color=factor(quality))) +
    geom_jitter(alpha=1/3, shape=21) +
    facet_wrap(~factor(quality), ncol=6) +
    labs(title='Volatile Acidity by Alcohol', y = 'Acetic Acid g/dm^3', x = 'Alcohol Percentage', color='Red Wine Quality') +
    theme(plot.title = element_text(hjust = 0.5))
```
